...
const clipboardFeed = ["line1", "line2", "line3", "line4"]
...
function onPasteToTextArea(text) {
 ...
 * @returns {Promise<string>} Address from local storage.
 */
...
function handlePageLoaded() {
    ...
    getAddressFromStorage().then(address => {
        ...
        removeAddressFromStorage().then(() => {
            // set manual address selection 
            // (only relevant if sending to Czechia)
